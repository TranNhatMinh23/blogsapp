    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="userTab" >
            <section>
                ...
                <!-- <form action="{{ route('profile.update', $profile->id) }}" id="form-avarta"  method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="file" onchange="readURL(this)" class="file-upload-input"  name="avarta" id="">
            ...
            <div class="row">
                ...
                <section>
                    ...
                    <div class="group-input">
                        ...
                        <input type="text" disabled name="" id="" value="{{ Auth::user()->slug }}">
                    </div>
                </section>
                </div>
            ...
            <div class="row">
                ...
                <section>
                    ...
                    <div class="group-input">
                        ...
                        <input type="tel" placeholder="Số điện thoại" name="" id="" value="{{ Auth::user()->phoneNumber }}">
                    </div>
                </section>
                </div>
                <div class="col-md-6">
                    <section>
                        ...
                        <div class="group-input">
                            ...
                            <input type="date" name="" id="" value="{{ Auth::user()->created_at }}">
                        </div>
                    </section>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="group-input">
                            ...
                            <input type="text" name="" id=""  value="{{ Auth::user()->fbsocial }}" placeholder="URL Facebook">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="group-input">
                            ...
                            <input type="text" name="" id="" value="{{ Auth::user()->linkedInSocial }}" placeholder="URL LinkedIn">
                        </div>
                    </div>
